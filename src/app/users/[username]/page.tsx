            ...
            <div className="flex gap-4 mt-4">
              <HoverCard>
                <HoverCardTrigger>
                  <BadgeCheck
                    size={36}
                    className="rounded-full bg-blue-500/30 border border-blue-50 p-2"
                  />
                </HoverCardTrigger>
                <HoverCardContent>
              ...
              <HoverCard>
                <HoverCardTrigger>
                  <Shield
                    size={36}
                    className="rounded-full bg-green-500/30 border border-green-50 p-2"
                  />
                </HoverCardTrigger>
                <HoverCardContent>
              ...
              <HoverCard>
                <HoverCardTrigger>
                  <Candy
                    size={36}
                    className="rounded-full bg-yellow-500/30 border border-yellow-50 p-2"
                  />
                </HoverCardTrigger>
                <HoverCardContent>
              ...
              <HoverCard>
                <HoverCardTrigger>
                  <Citrus
                    size={36}
                    className="rounded-full bg-red-500/30 border border-red-50 p-2"
                  />
                </HoverCardTrigger>
                <HoverCardContent>
          ...
          <div className="bg-primary-foreground p-4 rounded-lg">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="">+1 123 456 789</span>
              </div>
              <div className="flex items-center gap-2">
